...
var createMediaSource = exports.createMediaSource = function createMediaSource(url, timeout) {
  return new Promise(function (resolve, reject) {
    ...
    if (timeout) {
      timer = setTimeout(function () {
        return reject("loading media source timed out: '" + url + "'");
      }, timeout);
    }

    var onSourceReady = function onSourceReady() {
      clearTimeout(timer);
